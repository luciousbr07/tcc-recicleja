...
<body>
  <body class="corbody"> <!--bg-success bg-opacity-10-->
    <!--Inicio Navbar-->
  <header> 
...
<div class="container">
          <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            ...
            <ul class="nav col-md-6 justify-content-end">
              ...
              <li class="nav-item"><a href="../tcc-index/comoreciclar.php" class="nav-link px-2 text-body-secondary">Como separar</a></li>
