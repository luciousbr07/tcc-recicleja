...
<head>
    ...
    <title>Histórico</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-9ndCyUaIbzAi2FUVXJi0CjmCapSmO7SnpJef0486qhLnuZ2cdeRhO02iuK6FUUVM" crossorigin="anonymous">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02"> <!--1-->
        <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../tcc-usuario/comoreciclar.php">Como reciclar</a>
            </li>
            <li class="nav-item">
...
<main>
  ...
  <?php foreach ($coletadao->read() as $coleta) : ?>                    
    <div class="bloco">
      ...
      <div class="conteudo acao">
        <h2>Situação</h2>
        <?php 
          if(($coleta->getStatus()) == 1){ ?>
          <button type="button" class="btn btn-danger">Aguardando Catador</button>
        <?php 
          }
            else if($coleta->getStatus() == 2){ ?>
              <button type="button" class="btn btn-warning">Coleta Aceita</button>
        <?php 
            }
              else if($coleta->getStatus() == 3){ ?>
                <button type="button" class="btn btn-success">Coleta Concluída</button>
            <?php
               }
              else{ ?>
              <button type="button" class="btn btn-secondary">Coleta Recusada</button>
             <?php } ?>
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-6 justify-content-end">
      ...
      <li class="nav-item"><a href="../tcc-usuario/comoreciclar.php" class="nav-link px-2 text-body-secondary">Como reciclar</a></li>
