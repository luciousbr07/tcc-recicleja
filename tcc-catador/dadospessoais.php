    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02"> <!--1-->
      <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../tcc-catador/comoreciclar.php">Como reciclar</a>
          </li>
          <li class="nav-item">
...
<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-6 justify-content-end">
      ...
      <li class="nav-item"><a href="../tcc-catador/novacoleta.php" class="nav-link px-2 text-body-secondary">Nova coleta</a></li>
