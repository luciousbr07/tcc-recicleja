...
<main>
  ...
  <?php foreach ($coletadao->novaColeta() as $coleta) : ?>                    
    <div class="bloco">
      ...
      <div class="conteudo acao">
        <h2>Ação</h2>
        <a href="../controller/ColetaController.php?ac=<?php echo $coleta->getId_coleta() ?>&id_catador=<?php echo $_SESSION["id_cliente"] ?>"><button type="button" class="btn btn-success">Aceitar</button></a><br>
        <a href="../controller/ColetaController.php?rec=<?php echo $coleta->getId_coleta() ?>"><button type="button" class="btn btn-danger">Recusar</button></a><br>
        <p><?= $coleta->getData_cadastro()?></p>
