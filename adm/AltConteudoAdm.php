    ...
    <table class="table table-xs table-hover">
                ...
                <tbody>
                    <?php foreach ($conteudodao->read() as $conteudo) : ?>
                        <tr>
                            <td><?= $conteudo->getId_conteudo() ?></td>
                            <td><?= $conteudo->getTitulo() ?></td>
                            <td><?= $conteudo->getConteudo() ?></td>
                            <td><?= $conteudo->getPagina() ?></td>
                            <td><img src="<?php echo $conteudo->getCaminho_img() ?>" width="80px" alt="descarte"></td>
                            <td><?= $conteudo->getCaminho_img() ?></td>
                            <td class="">
                            <button class="btn  btn-warning btn-sm" data-toggle="modal" data-target="#editar><?= $conteudo->getId_conteudo() ?>"> 
                                Editar
                            </button>
                                <a href="../controller/ConteudoController.php?del=<?= $conteudo->getId_conteudo() ?>">
                         ...
                         <!-- Modal -->
                         <div class="modal fade" id="editar><?= $conteudo->getId_conteudo() ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../controller/ConteudoController.php" method="POST" enctype="multipart/form-data">
                                           <div class="row"> 
                                                <div class="col-md-12"> 
                                                <label>Titulo: </label>
                                                    <input type="text" name="titulo" value="<?= $conteudo->getTitulo() ?>" class="form-control"  />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label>Conteudo: </label>
                                                    <textarea name="conteudo" id=conteudo cols="30" rows="10" class="form-control"><?php echo $conteudo->getConteudo() ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="pagina" id="pagina" class="form-control">
                                                        <option value="Index e Como separar" selected>Index e Como separar</option>
                                                        <option value="Como separar">Como separar</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Imagem: </label>
                                                    <input type="file" name="imagem" value="<?= $conteudo->getImagem() ?>" class="form-control"  />
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Caminho Imagem: </label>
                                                    <input type="text" name="caminho_img" value="<?= $conteudo->getCaminho_img() ?>" class="form-control"  />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <br>
                                                    <input type="hidden" name="id_conteudo" value="<?= $conteudo->getId_conteudo() ?>" />
