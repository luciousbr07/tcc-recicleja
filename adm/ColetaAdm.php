    ...
    <table class="table table-xs table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Status</th>
                        <th>Id_cliente</th>
                        <th>Info_adicionais</th>
                        <th>Horario_disponivel_Inc</th>
                        <th>Horario_disponivel_Fim</th>
                        <th>Id_catador</th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($coletadao->read() as $coleta) : ?>
                        <tr>
                            <td><?= $coleta->getId_coleta() ?></td>
                            <td><?= $coleta->getData_cadastro() ?></td>
                            <td><?= $coleta->getData_coleta() ?></td>
                            <td><?= $coleta->getStatus() ?></td>
                            <td><?= $coleta->getId_cliente() ?></td>
                            <td><?= $coleta->getInfo_adicionais() ?></td>
                            <td><?= $coleta->getHr_disp_inicial() ?></td>
                            <td><?= $coleta->getHr_disp_final() ?></td>
                            <td><?= $coleta->getId_catador() ?></td>
                            <td class="">
                                <button class="btn  btn-warning btn-sm" data-toggle="modal" data-target="#editar><?= $coleta->getId_coleta() ?>">
                                    Editar
                                </button>
                                <a href="controller/ColetaController.php?del=<?= $coleta->getId_coleta() ?>">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="editar><?= $coleta->getId_coleta() ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <form action="../controller/ColetaController.php" method="POST">
                                           <div class="row"> 
                                                ...
                                                <label>Data cadastro: </label>
                                                    <input type="text" name="data_cadastro" value="<?= $coleta->getData_cadastro() ?>" class="form-control"  />
                                                </div>
                                                <div class="col-md-5">
                                                    <label>Data coleta: </label>
                                                    <input type="text" name="data_coleta" value="<?= $coleta->getData_coleta() ?>" class="form-control"  />
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Status: </label>
                                                    <input type="text" name="status" value="<?= $coleta->getStatus() ?>" class="form-control"  />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label>Info adicionais: </label>
                                                    <input type="text" name="info_adicionais" value="<?= $coleta->getInfo_adicionais() ?>" class="form-control"  />
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Horario disponivel Inc: </label>
                                                    <input type="text" name="hr_disp_inicial" value="<?= $coleta->getHr_disp_inicial() ?>" class="form-control"/>
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Horario disponivel Fim: </label>
                                                    <input type="text" name="hr_disp_final" value="<?= $coleta->getHr_disp_final() ?>" class="form-control"/>
                                                </div>
                                               
                                                    <br>
                                                    <input type="hidden" name="id_coleta" value="<?= $coleta->getId_coleta() ?>" />
                                                    <button class="btn btn-primary" type="submit" name="editar_adm">Cadastrar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
